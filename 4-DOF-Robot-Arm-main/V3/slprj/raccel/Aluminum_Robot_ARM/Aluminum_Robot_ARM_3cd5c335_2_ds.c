...
#include "Aluminum_Robot_ARM_3cd5c335_2_ds_obs_il.h"
#include "Aluminum_Robot_ARM_3cd5c335_2_ds_obs_all.h"
#include "Aluminum_Robot_ARM_3cd5c335_2_ds_obs_act.h"
#include "Aluminum_Robot_ARM_3cd5c335_2_ds_obs_exp.h"
#include "Aluminum_Robot_ARM_3cd5c335_2_ds_log.h"
#include "Aluminum_Robot_ARM_3cd5c335_2_ds_dxf.h"
#include "Aluminum_Robot_ARM_3cd5c335_2_ds_f.h"
#include "Aluminum_Robot_ARM_3cd5c335_2_ds.h"
...
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 2U , 0U ,
TRUE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 2U , 2U ,
TRUE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 5U , 4U , TRUE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Interface/Ideal Torque Sensor"
, 1U , 9U , TRUE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 10U , FALSE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME
,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 9U , 11U , TRUE , 1.0 , "1" , } } ; static NeVariableData s_variable_data [
6 ] = { { "ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.w" , 0U , 0 ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1.0 , "1" ,
0.0 , TRUE , 1U , 1U , NE_INIT_MODE_MANDATORY , "Angular velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.i_L" , 0U , 0 ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1.0 , "1" ,
0.0 , TRUE , 1U , 1U , NE_INIT_MODE_MANDATORY , "Current" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.v_lag" , 0U , 0 ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1.0 , "1" , 0.0 , TRUE , 1U , 1U , NE_INIT_MODE_MANDATORY , "Lag variable"
, } , { "ROBOT4DOF.DC_Motors.Wrist_Interface.Ideal_Angular_Velocity_Source.t"
, 0U , 0 ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Interface/Ideal Angular Velocity Source"
, 1.0 , "1" , 0.0 , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "Torque" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.v" , 0U , 0 ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1.0 , "1" ,
0.0 , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.p2.v"
, 0U , 1 ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1.0 , "1" , 0.0 , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "Voltage" , } } ;
static NeVariableData * s_discrete_data = NULL ; static NeObservableData
s_observable_data [ 76 ] = { { "ROBOT4DOF.DC_Motors.Wrist_Interface.C.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Interface" , 1U , 1U , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Interface.Ideal_Angular_Velocity_Source.C.w" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Interface/Ideal Angular Velocity Source"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Interface.Ideal_Angular_Velocity_Source.R.w" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Interface/Ideal Angular Velocity Source"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Interface.Ideal_Angular_Velocity_Source.S" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Interface/Ideal Angular Velocity Source"
...
"ROBOT4DOF.DC_Motors.Wrist_Interface.Ideal_Angular_Velocity_Source.w" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Interface/Ideal Angular Velocity Source"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Angular velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Interface.Ideal_Torque_Sensor.C.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Interface/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Interface.Ideal_Torque_Sensor.R.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Interface/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Interface.Ideal_Torque_Sensor.T" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Interface/Ideal Torque Sensor"
, 1U , 1U , "N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE
...
, 1U , 1U , "N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE
, FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Interface.Ideal_Torque_Sensor.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Interface/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Angular velocity" , } , { "ROBOT4DOF.DC_Motors.Wrist_Interface.R.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Interface" , 1U , 1U , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE
, NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.C.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1U , 1U ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.R.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1U , 1U ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.i" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1U , 1U , "A"
, 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.i_L" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1U , 1U , "A"
, 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_MANDATORY , FALSE , TRUE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.n.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1U , 1U , "V"
, 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.p.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1U , 1U , "V"
, 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.power_dissipated" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1U , 1U , "W"
, 1.0 , "kW" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Power dissipated" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.t" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1U , 1U ,
"N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1U , 1U , "V"
, 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1U , 1U ,
"rpm" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_MANDATORY ,
FALSE , TRUE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Angular velocity" , } ,
{ "ROBOT4DOF.DC_Motors.Wrist_Motor.Electrical_Reference2.V.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Electrical Reference2" ,
1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Gear_Box.O.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Gear Box" , 1U , 1U ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Gear_Box.S.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Gear Box" , 1U , 1U ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Gear_Box.t_in" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Gear Box" , 1U , 1U ,
"N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Input shaft incoming torque" ,
} , { "ROBOT4DOF.DC_Motors.Wrist_Motor.Gear_Box.t_out" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Gear Box" , 1U , 1U ,
"N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Output shaft incoming torque"
, } , { "ROBOT4DOF.DC_Motors.Wrist_Motor.Housing.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor" , 1U , 1U , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Mechanical_Rotational_Reference.W.w" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Mechanical Rotational Reference"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.i1" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Input current" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.n1.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.n2.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.p1.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
...
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.duty_cycle"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "1" , 1.0 , "1" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Duty cycle" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.i2"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Output current" , } , {
 "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.n2.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.p2.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.v2"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Output voltage" , } ,
{ "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.Electrical_Reference1.V.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Electrical Reference1"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.BRK.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.ENA.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.REF.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.REV.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.i2" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (+ -> -)" , }
, { "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.iBRK" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (BRK -> REF)" ,
} , { "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.iENA" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (ENA -> REF)" ,
} , { "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.iREV" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (REV -> REF)" ,
} , { "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.n2.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.p2.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.power_dissipated" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "W" , 1.0 , "kW" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Power dissipated" , }
, { "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge.v_lag" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL ,
NE_INIT_MODE_MANDATORY , FALSE , TRUE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Lag variable" , } , {
 "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Electrical_Reference1.V.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Electrical Reference1"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.i" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.n.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.p.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.v" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "v" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.vT" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_FIXED , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "vT" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vbrk.Volts.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vbrk"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
 "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Electrical_Reference1.V.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Electrical Reference1"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.i" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.n.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.p.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.v" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "v" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.vT"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_FIXED , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "vT" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vduty.Volts.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vduty"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
 "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Electrical_Reference1.V.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Electrical Reference1"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.i" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.n.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.p.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.v" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "v" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.vT" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_FIXED , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "vT" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Volts.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/SL2Vrev"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.V0.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier" , 1U ,
1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.V1.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier" , 1U ,
1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Wrist_Motor.Shaft.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor" , 1U , 1U , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } } ; static
NeModeData * s_major_mode_data = NULL ; static NeZCData s_zc_data [ 5 ] = { {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 0U , "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, NE_ZC_TYPE_FALSE , } , {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, NE_ZC_TYPE_FALSE , } , {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 2U , "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, NE_ZC_TYPE_FALSE , } , {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 3U , "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, NE_ZC_TYPE_FALSE , } , {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 4U , "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
...
s_assert_data [ 7 ] = { {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/DC Motor" , 1U , 0U ,
"ROBOT4DOF.DC_Motors.Wrist_Motor.DC_Motor" ,
...
, "physmod:common:mf:core:asserts:RequireBaseNonnegative" , } , {
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 4U ,
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.Controlled_PWM_Voltage" ,
...
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 5U , "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, FALSE , "In divide, the denominator must be nonzero." ,
"physmod:common:mf:core:asserts:RequireDenominatorNonzero" , } , {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Wrist Motor/Power Amplifier/H-Bridge"
, 1U , 6U , "ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, FALSE , "In divide, the denominator must be nonzero." ,
...
-> mN ) ; } NeDynamicSystem * Aluminum_Robot_ARM_3cd5c335_2_dae_ds (
...
mName = "ROBOT4DOF.DC_Motors.Wrist_Interface.Ideal_Angular_Velocity_Source.S"
...
mName =
"ROBOT4DOF.DC_Motors.Wrist_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.vT" ;
input_info [ 3 ] . mUnit = "V" ; ds -> mIo [ NE_INPUT_IO_TYPE ] = input_info
; ds -> mNumIo [ NE_OUTPUT_IO_TYPE ] = 1 ; output_info [ 0 ] . mIdentifier =
"ROBOT4DOF.DC_Motors.Wrist_Interface.Ideal_Torque_Sensor.T" ; output_info [ 0
] . mM = 1 ; output_info [ 0 ] . mN = 1 ; output_info [ 0 ] . mName =
"ROBOT4DOF.DC_Motors.Wrist_Interface.Ideal_Torque_Sensor.T" ; output_info [ 0
] . mUnit = "N*m" ; ds -> mIo [ NE_OUTPUT_IO_TYPE ] = output_info ; ds ->
...
mMethods [ NE_DS_METHOD_M_P ] = ds_m_p ; ds -> mMakeOutput [ NE_DS_METHOD_M_P
...
Aluminum_Robot_ARM_3cd5c335_2_ds_f ; ds -> mMakeOutput [ NE_DS_METHOD_F ] =
...
Aluminum_Robot_ARM_3cd5c335_2_ds_dxf ; ds -> mMakeOutput [ NE_DS_METHOD_DXF ]
...
Aluminum_Robot_ARM_3cd5c335_2_ds_zc ; ds -> mMakeOutput [ NE_DS_METHOD_ZC ] =
...
NE_DS_METHOD_LOG ] = Aluminum_Robot_ARM_3cd5c335_2_ds_log ; ds -> mMakeOutput
...
Aluminum_Robot_ARM_3cd5c335_2_ds_obs_exp ; ds -> mMakeOutput [
NE_DS_METHOD_OBS_EXP ] = ds_output_obs_exp ; ds -> mMethods [
NE_DS_METHOD_OBS_ACT ] = Aluminum_Robot_ARM_3cd5c335_2_ds_obs_act ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ACT ] = ds_output_obs_act ; ds -> mMethods [
NE_DS_METHOD_OBS_ALL ] = Aluminum_Robot_ARM_3cd5c335_2_ds_obs_all ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ALL ] = ds_output_obs_all ; ds -> mMethods [
NE_DS_METHOD_OBS_IL ] = Aluminum_Robot_ARM_3cd5c335_2_ds_obs_il ; ds ->
...
out . mX [ 0 ] = 0.18267719933686666 ; out . mX [ 1 ] = -
0.000799224171263225 ; out . mX [ 2 ] = - 0.0625 ; out . mX [ 3 ] =
0.83743100934802894 ; out . mX [ 4 ] = 0.999999999162569 ; out . mX [ 5 ] = -
0.34213355675771651 ; out . mX [ 6 ] = - 0.999999999162569 ; out . mX [ 7 ] =
9.99999999162569E-10 ; out . mX [ 8 ] = 0.2 ; ( void ) sys ; ( void ) t2 ;
...
out ; ( void ) t1 ; out = t2 -> mM ; out . mX [ 0 ] = 0.027918098231429669 ;
