...
#endif
#include "nesl_rtw.h"
#include "Aluminum_Robot_ARM_3cd5c335_3.h"
void Aluminum_Robot_ARM_3cd5c335_3_gateway ( void ) { NeModelParameters
...
Aluminum_Robot_ARM_3cd5c335_3_dae ( & dae , & modelparams , & solverparams )
; nesl_register_simulator_group (
"Aluminum_Robot_ARM/ROBOT4DOF/Subsystem/Solver Configuration_3" , 1 , & dae ,
