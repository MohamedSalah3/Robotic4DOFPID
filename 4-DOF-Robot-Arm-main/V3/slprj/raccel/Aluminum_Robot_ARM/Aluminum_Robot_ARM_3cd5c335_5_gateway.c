...
#endif
#include "nesl_rtw.h"
#include "Aluminum_Robot_ARM_3cd5c335_5.h"
void Aluminum_Robot_ARM_3cd5c335_5_gateway ( void ) { NeModelParameters
...
Aluminum_Robot_ARM_3cd5c335_5_dae ( & dae , & modelparams , & solverparams )
; nesl_register_simulator_group (
"Aluminum_Robot_ARM/ROBOT4DOF/Subsystem/Solver Configuration_5" , 1 , & dae ,
