...
#include "ne_ds.h"
#include "Aluminum_Robot_ARM_3cd5c335_4_ds_zc.h"
#include "Aluminum_Robot_ARM_3cd5c335_4_ds_obs_il.h"
#include "Aluminum_Robot_ARM_3cd5c335_4_ds_obs_all.h"
#include "Aluminum_Robot_ARM_3cd5c335_4_ds_obs_act.h"
#include "Aluminum_Robot_ARM_3cd5c335_4_ds_obs_exp.h"
#include "Aluminum_Robot_ARM_3cd5c335_4_ds_log.h"
#include "Aluminum_Robot_ARM_3cd5c335_4_ds_dxf.h"
#include "Aluminum_Robot_ARM_3cd5c335_4_ds_f.h"
#include "Aluminum_Robot_ARM_3cd5c335_4_ds.h"
...
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 2U , 0U ,
TRUE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 2U , 2U ,
TRUE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 5U , 4U , TRUE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface/Ideal Torque Sensor"
, 1U , 9U , TRUE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 10U , FALSE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME
,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 9U , 11U , TRUE , 1.0 , "1" , } } ; static NeVariableData s_variable_data [
6 ] = { { "ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.w" , 0U , 0 ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1.0 , "1" ,
0.0 , TRUE , 1U , 1U , NE_INIT_MODE_MANDATORY , "Angular velocity" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.i_L" , 0U , 0 ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1.0 , "1" ,
0.0 , TRUE , 1U , 1U , NE_INIT_MODE_MANDATORY , "Current" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.v_lag" , 0U , 0 ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1.0 , "1" , 0.0 , TRUE , 1U , 1U , NE_INIT_MODE_MANDATORY , "Lag variable"
, } , {
"ROBOT4DOF.DC_Motors.Forearm_Interface.Ideal_Angular_Velocity_Source.t" , 0U
, 0 ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface/Ideal Angular Velocity Source"
, 1.0 , "1" , 0.0 , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "Torque" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.v" , 0U , 0 ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1.0 , "1" ,
0.0 , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.Controlled_PWM_Voltage.p2.v"
, 0U , 1 ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Controlled PWM Voltage"
, 1.0 , "1" , 0.0 , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "Voltage" , } } ;
static NeVariableData * s_discrete_data = NULL ; static NeObservableData
s_observable_data [ 76 ] = { { "ROBOT4DOF.DC_Motors.Forearm_Interface.C.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface" , 1U , 1U ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "ROBOT4DOF.DC_Motors.Forearm_Interface.Ideal_Angular_Velocity_Source.C.w" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface/Ideal Angular Velocity Source"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Interface.Ideal_Angular_Velocity_Source.R.w" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface/Ideal Angular Velocity Source"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Interface.Ideal_Angular_Velocity_Source.S" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface/Ideal Angular Velocity Source"
, 1U , 1U , "rad/s" , 1.0 , "rad/s" , NE_NOMINAL_SOURCE_FIXED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "S"
, } , {
"ROBOT4DOF.DC_Motors.Forearm_Interface.Ideal_Angular_Velocity_Source.t" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface/Ideal Angular Velocity Source"
, 1U , 1U , "N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE
, FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Interface.Ideal_Angular_Velocity_Source.w" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface/Ideal Angular Velocity Source"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Angular velocity" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Interface.Ideal_Torque_Sensor.C.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Interface.Ideal_Torque_Sensor.R.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Interface.Ideal_Torque_Sensor.T" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface/Ideal Torque Sensor"
, 1U , 1U , "N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE
...
, 1U , 1U , "N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE
, FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Interface.Ideal_Torque_Sensor.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface/Ideal Torque Sensor"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Angular velocity" , } , { "ROBOT4DOF.DC_Motors.Forearm_Interface.R.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Interface" , 1U , 1U ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } ,
{ "ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.C.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1U , 1U ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.R.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1U , 1U ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.i" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1U , 1U ,
"A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.i_L" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1U , 1U ,
"A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_MANDATORY , FALSE ,
TRUE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.n.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1U , 1U ,
"V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.p.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1U , 1U ,
"V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.power_dissipated" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1U , 1U ,
"W" , 1.0 , "kW" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Power dissipated" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.t" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1U , 1U ,
"N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1U , 1U ,
"V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1U , 1U ,
"rpm" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_MANDATORY ,
FALSE , TRUE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Angular velocity" , } ,
{ "ROBOT4DOF.DC_Motors.Forearm_Motor.Electrical_Reference2.V.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Electrical Reference2"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Gear_Box.O.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Gear Box" , 1U , 1U ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Gear_Box.S.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Gear Box" , 1U , 1U ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Gear_Box.t_in" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Gear Box" , 1U , 1U ,
"N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Input shaft incoming torque" ,
} , { "ROBOT4DOF.DC_Motors.Forearm_Motor.Gear_Box.t_out" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Gear Box" , 1U , 1U ,
"N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Output shaft incoming torque"
, } , { "ROBOT4DOF.DC_Motors.Forearm_Motor.Housing.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor" , 1U , 1U , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Mechanical_Rotational_Reference.W.w" ,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Mechanical Rotational Reference"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.Controlled_PWM_Voltage.i1"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Input current" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.Controlled_PWM_Voltage.n1.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.Controlled_PWM_Voltage.n2.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.Controlled_PWM_Voltage.p1.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
...
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.duty_cycle"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "1" , 1.0 , "1" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Duty cycle" , } , {
 "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.i2"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Output current" , } , {
 "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.n2.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.p2.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
 "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.Controlled_PWM_Voltage.pwm.v2"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Output voltage" , } ,
{
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.Electrical_Reference1.V.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Electrical Reference1"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.BRK.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.ENA.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.REF.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.REV.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.i2" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (+ -> -)" , }
, { "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.iBRK" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (BRK -> REF)" ,
} , { "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.iENA" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (ENA -> REF)" ,
} , { "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.iREV" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (REV -> REF)" ,
} , { "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.n2.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.p2.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.power_dissipated"
,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "W" , 1.0 , "kW" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Power dissipated" , }
, { "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge.v_lag" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL ,
NE_INIT_MODE_MANDATORY , FALSE , TRUE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Lag variable" , } , {
 "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vbrk.Electrical_Reference1.V.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vbrk/Electrical Reference1"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.i"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.n.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.p.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "v" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vbrk.Voltage_Source.vT"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vbrk/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_FIXED , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "vT" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vbrk.Volts.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vbrk"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
 "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vduty.Electrical_Reference1.V.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vduty/Electrical Reference1"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.i"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.n.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.p.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "v" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vduty.Voltage_Source.vT"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vduty/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_FIXED , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "vT" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vduty.Volts.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vduty"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
 "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vrev.Electrical_Reference1.V.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vrev/Electrical Reference1"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.i"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "i" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.n.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.p.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.v"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "v" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vrev.Voltage_Source.vT"
,
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vrev/Voltage Source"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_FIXED , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "vT" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.SL2Vrev.Volts.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/SL2Vrev"
, 1U , 1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.V0.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier" , 1U ,
1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.V1.v" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier" , 1U ,
1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"ROBOT4DOF.DC_Motors.Forearm_Motor.Shaft.w" ,
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor" , 1U , 1U , "rad/s" ,
...
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 0U , "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, NE_ZC_TYPE_FALSE , } , {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 1U , "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, NE_ZC_TYPE_FALSE , } , {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 2U , "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, NE_ZC_TYPE_FALSE , } , {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 3U , "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, NE_ZC_TYPE_FALSE , } , {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 4U , "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
...
s_assert_data [ 7 ] = { {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/DC Motor" , 1U , 0U ,
"ROBOT4DOF.DC_Motors.Forearm_Motor.DC_Motor" ,
...
, "physmod:common:mf:core:asserts:RequireBaseNonnegative" , } , {
 "Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/Controlled PWM Voltage"
, 1U , 4U ,
"ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.Controlled_PWM_Voltage" ,
...
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 5U , "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, FALSE , "In divide, the denominator must be nonzero." ,
"physmod:common:mf:core:asserts:RequireDenominatorNonzero" , } , {
"Aluminum_Robot_ARM/ROBOT4DOF/DC Motors/Forearm Motor/Power Amplifier/H-Bridge"
, 1U , 6U , "ROBOT4DOF.DC_Motors.Forearm_Motor.Power_Amplifier.H_Bridge" ,
 "C:/Program Files/Polyspace/R2019a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, FALSE , "In divide, the denominator must be nonzero." ,
...
mMDUY_P . mNumRow = 1 ; out -> mMDUY_P . mJc = ( int32_T * ) allocator ->
...
mMDXY_P . mNumRow = 1 ; out -> mMDXY_P . mJc = ( int32_T * ) allocator ->
...
mTDUY_P . mNumRow = 1 ; out -> mTDUY_P . mJc = ( int32_T * ) allocator ->
...
mTDXY_P . mNumRow = 1 ; out -> mTDXY_P . mJc = ( int32_T * ) allocator ->
...
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mLOG . mN = 76 ; out
-> mLOG . mX = ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof (
real_T ) , 76 ) ; return out ; } static NeDsMethodOutput * ds_output_assert (
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
...
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mOBS_EXP . mN = 76 ;
out -> mOBS_EXP . mX = ( real_T * ) allocator -> mCallocFcn ( allocator ,
sizeof ( real_T ) , 76 ) ; return out ; } static NeDsMethodOutput *
ds_output_obs_act ( const NeDynamicSystem * ds , PmAllocator * allocator ) {
NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator
-> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out ->
mOBS_ACT . mN = 76 ; out -> mOBS_ACT . mX = ( real_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( real_T ) , 76 ) ; return out ; } static
NeDsMethodOutput * ds_output_obs_all ( const NeDynamicSystem * ds ,
PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mOBS_ALL . mN = 76 ; out -> mOBS_ALL . mX =
( real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T ) , 76 ) ;
return out ; } static NeDsMethodOutput * ds_output_obs_il ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mOBS_IL . mN = 76 ; out ->
mOBS_IL . mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof (
boolean_T ) , 76 ) ; return out ; } static NeDsMethodOutput * ds_output_dp_l
( const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
...
-> mN ) ; } NeDynamicSystem * Aluminum_Robot_ARM_3cd5c335_4_dae_ds (
...
mNumObservables = 76 ; ds -> mNumObservableElements = 76 ; ds -> mNumZcs = 5
...
mIdentifier = "ROBOT4DOF.DC_Motors.Forearm_Interface.Ideal_Torque_Sensor.T" ;
output_info [ 0 ] . mM = 1 ; output_info [ 0 ] . mN = 1 ; output_info [ 0 ] .
mName = "ROBOT4DOF.DC_Motors.Forearm_Interface.Ideal_Torque_Sensor.T" ;
...
Aluminum_Robot_ARM_3cd5c335_4_ds_f ; ds -> mMakeOutput [ NE_DS_METHOD_F ] =
...
Aluminum_Robot_ARM_3cd5c335_4_ds_dxf ; ds -> mMakeOutput [ NE_DS_METHOD_DXF ]
...
Aluminum_Robot_ARM_3cd5c335_4_ds_zc ; ds -> mMakeOutput [ NE_DS_METHOD_ZC ] =
...
NE_DS_METHOD_LOG ] = Aluminum_Robot_ARM_3cd5c335_4_ds_log ; ds -> mMakeOutput
...
Aluminum_Robot_ARM_3cd5c335_4_ds_obs_exp ; ds -> mMakeOutput [
NE_DS_METHOD_OBS_EXP ] = ds_output_obs_exp ; ds -> mMethods [
NE_DS_METHOD_OBS_ACT ] = Aluminum_Robot_ARM_3cd5c335_4_ds_obs_act ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ACT ] = ds_output_obs_act ; ds -> mMethods [
NE_DS_METHOD_OBS_ALL ] = Aluminum_Robot_ARM_3cd5c335_4_ds_obs_all ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ALL ] = ds_output_obs_all ; ds -> mMethods [
NE_DS_METHOD_OBS_IL ] = Aluminum_Robot_ARM_3cd5c335_4_ds_obs_il ; ds ->
...
mJc [ 5 ] = 4 ; out . mJc [ 6 ] = 4 ; out . mIr [ 0 ] = 5 ; out . mIr [ 1 ] =
5 ; out . mIr [ 2 ] = 2 ; out . mIr [ 3 ] = 5 ; ( void ) sys ; ( void ) t2 ;
...
real_T U_idx_1 ; U_idx_1 = t1 -> mU . mX [ 1 ] ; out = t2 -> mDUF ; if (
U_idx_1 <= 0.0 ) { U_idx_1 = 0.0 ; } else if ( U_idx_1 >= 5.0 ) { U_idx_1 =
0.0 ; } else { U_idx_1 = 0.2 ; } out . mX [ 0 ] = - U_idx_1 ; ( void ) sys ;
...
4ULL ; out . mNumRow = 6ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out
. mJc [ 2 ] = 1 ; out . mJc [ 3 ] = 1 ; out . mJc [ 4 ] = 1 ; out . mIr [ 0 ]
= 4 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dtf ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { ( void ) t1 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
ds_dtf_p ( const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mDTF_P ; out . mNumCol = 1ULL ; out . mNumRow = 6ULL ; out . mJc [ 0 ] = 0 ;
out . mJc [ 1 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
...
out . mX [ 0 ] = 0.13841069347875293 ; out . mX [ 1 ] = -
0.0010548319311207322 ; out . mX [ 2 ] = - 0.0625 ; out . mX [ 3 ] =
0.46279026285886082 ; out . mX [ 4 ] = 0.99999999953720975 ; out . mX [ 5 ] =
- 0.451554705783407 ; out . mX [ 6 ] = - 0.99999999953720975 ; out . mX [ 7 ]
= 9.9999999953720988E-10 ; out . mX [ 8 ] = 0.2 ; ( void ) sys ; ( void ) t2
...
( void ) t1 ; out = t2 -> mA_P ; out . mNumCol = 6ULL ; out . mNumRow = 6ULL
; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 3 ; out . mJc [ 2 ] = 5 ; out . mJc
[ 3 ] = 5 ; out . mJc [ 4 ] = 6 ; out . mJc [ 5 ] = 8 ; out . mJc [ 6 ] = 9 ;
out . mIr [ 0 ] = 0 ; out . mIr [ 1 ] = 1 ; out . mIr [ 2 ] = 3 ; out . mIr [
3 ] = 0 ; out . mIr [ 4 ] = 1 ; out . mIr [ 5 ] = 1 ; out . mIr [ 6 ] = 0 ;
out . mIr [ 7 ] = 1 ; out . mIr [ 8 ] = 4 ; ( void ) sys ; ( void ) t2 ;
return 0 ; } static int32_T ds_b ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmRealVector out ; (
void ) t1 ; out = t2 -> mB ; out . mX [ 0 ] = 1.0 ; ( void ) sys ; ( void )
t2 ; return 0 ; } static int32_T ds_b_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mB_P ; out . mNumCol = 4ULL ; out . mNumRow = 6ULL
; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 1 ; out . mJc [ 2 ] = 1 ; out . mJc
[ 3 ] = 1 ; out . mJc [ 4 ] = 1 ; out . mIr [ 0 ] = 3 ; ( void ) sys ; ( void
) t2 ; return 0 ; } static int32_T ds_c ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { ( void ) t1 ; ( void )
...
out ; ( void ) t1 ; out = t2 -> mDNF_P ; out . mNumCol = 5ULL ; out . mNumRow
= 6ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ;
out . mJc [ 3 ] = 1 ; out . mJc [ 4 ] = 1 ; out . mJc [ 5 ] = 1 ; out . mIr [
0 ] = 4 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dnf_v_x
...
true ; out . mX [ 3 ] = false ; out . mX [ 4 ] = false ; out . mX [ 5 ] =
...
0.0 ; out . mX [ 1 ] = 0.0 ; out . mX [ 2 ] = 1.0 ; out . mX [ 3 ] = 0.0 ;
out . mX [ 4 ] = 0.0 ; out . mX [ 5 ] = 0.0 ; ( void ) sys ; ( void ) t2 ;
...
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mDXICR_P ; out . mNumCol = 6ULL ; out . mNumRow = 0ULL ; out . mJc [ 0 ] = 0
; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc
[ 4 ] = 0 ; out . mJc [ 5 ] = 0 ; out . mJc [ 6 ] = 0 ; ( void ) sys ; ( void
) t2 ; return 0 ; } static int32_T ds_tduicr_p ( const NeDynamicSystem * sys
, const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) {
PmSparsityPattern out ; ( void ) t1 ; out = t2 -> mTDUICR_P ; out . mNumCol =
4ULL ; out . mNumRow = 0ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out
. mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; ( void ) sys ;
( void ) t2 ; return 0 ; } static int32_T ds_m ( const NeDynamicSystem * sys
, const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmRealVector
out ; ( void ) t1 ; out = t2 -> mM ; out . mX [ 0 ] = 0.036846863991926014 ;
out . mX [ 1 ] = - 0.002 ; out . mX [ 2 ] = 1.0 ; ( void ) sys ; ( void ) t2
; return 0 ; } static int32_T ds_m_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mM_P ; out . mNumCol = 6ULL ; out . mNumRow = 6ULL
; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 1 ; out . mJc [ 2 ] = 2 ; out . mJc
[ 3 ] = 3 ; out . mJc [ 4 ] = 3 ; out . mJc [ 5 ] = 3 ; out . mJc [ 6 ] = 3 ;
out . mIr [ 0 ] = 1 ; out . mIr [ 1 ] = 0 ; out . mIr [ 2 ] = 2 ; ( void )
sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dxm ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { ( void ) t1 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
ds_dxm_p ( const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mDXM_P ; out . mNumCol = 6ULL ; out . mNumRow = 3ULL ; out . mJc [ 0 ] = 0 ;
out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc [
4 ] = 0 ; out . mJc [ 5 ] = 0 ; out . mJc [ 6 ] = 0 ; ( void ) sys ; ( void )
t2 ; return 0 ; } static int32_T ds_dum ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { ( void ) t1 ; ( void )
sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dum_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 -> mDUM_P ; out .
mNumCol = 4ULL ; out . mNumRow = 3ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ]
= 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; (
void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dtm ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { ( void ) t1 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
...
const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmIntVector out ; real_T X_idx_4 ; real_T U_idx_2 ;
real_T U_idx_3 ; real_T X_idx_5 ; U_idx_2 = t1 -> mU . mX [ 2 ] ; U_idx_3 =
t1 -> mU . mX [ 3 ] ; X_idx_4 = t1 -> mX . mX [ 4 ] ; X_idx_5 = t1 -> mX . mX
[ 5 ] ; out = t2 -> mMODE ; out . mX [ 0 ] = ( int32_T ) ( U_idx_2 > 2.5 ) ;
out . mX [ 1 ] = ( int32_T ) ( U_idx_2 > 2.5 ) ; out . mX [ 2 ] = ( int32_T )
( X_idx_5 > 2.5 ) ; out . mX [ 3 ] = ( int32_T ) ( U_idx_3 > 2.5 ) ; out . mX
[ 4 ] = ( int32_T ) ( X_idx_4 * ( U_idx_3 > 2.5 ? - 1.0 : 1.0 ) > 0.0 ) ; (
...
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mQX_P ; out . mNumCol = 6ULL ; out . mNumRow = 6ULL ; out . mJc [ 0 ] = 0 ;
out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc [
4 ] = 0 ; out . mJc [ 5 ] = 0 ; out . mJc [ 6 ] = 0 ; ( void ) sys ; ( void )
t2 ; return 0 ; } static int32_T ds_qu_p ( const NeDynamicSystem * sys ,
const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern
out ; ( void ) t1 ; out = t2 -> mQU_P ; out . mNumCol = 4ULL ; out . mNumRow
= 6ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ;
out . mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; ( void ) sys ; ( void ) t2 ;
...
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { PmRealVector out ; real_T X_idx_3 ; X_idx_3 = t1 -> mX . mX [ 3 ] ;
out = t2 -> mY ; out . mX [ 0 ] = X_idx_3 ; ( void ) sys ; ( void ) t2 ;
...
const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern
out ; ( void ) t1 ; out = t2 -> mDXY_P ; out . mNumCol = 6ULL ; out . mNumRow
= 1ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ;
out . mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 1 ; out . mJc [ 5 ] = 1 ; out . mJc [
6 ] = 1 ; out . mIr [ 0 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; }
...
mNumCol = 4ULL ; out . mNumRow = 1ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ]
= 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; (
...
mNumCol = 6ULL ; out . mNumRow = 1ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ]
= 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; out .
mJc [ 5 ] = 0 ; out . mJc [ 6 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ;
} static int32_T ds_tduy_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mTDUY_P ; out . mNumCol = 4ULL ; out . mNumRow =
1ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out
. mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0
; } static int32_T ds_tdxy_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mTDXY_P ; out . mNumCol = 6ULL ; out . mNumRow =
1ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out
. mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 1 ; out . mJc [ 5 ] = 1 ; out . mJc [ 6 ]
