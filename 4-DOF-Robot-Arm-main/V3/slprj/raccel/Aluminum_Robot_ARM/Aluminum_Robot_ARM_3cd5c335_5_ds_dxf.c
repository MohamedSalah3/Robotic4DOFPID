...
int32_T Aluminum_Robot_ARM_3cd5c335_5_ds_dxf ( const NeDynamicSystem * sys ,
...
t6 -> mDXF ; if ( M_idx_0 != 0 ) { t0 = - 1.0380802010906473E-11 ; } else if
( M_idx_1 != 0 ) { t0 = - 1.0380802010906473E-11 ; } else { t0 = -
1.3841069347875295E-11 ; } if ( M_idx_0 != 0 ) { t1 = 0.074999999965290748 ;
} else if ( M_idx_1 != 0 ) { t1 = 0.074999999965290748 ; } else { t1 =
0.099999999953720983 ; } if ( M_idx_0 != 0 ) { t2 = 1.000000000075 ; } else
